...
class RustDeskToken(models.Model):
    ...
    uid = models.CharField(verbose_name=_('User ID'), max_length=16)
    ...
    create_time = models.DateTimeField(verbose_name=_('Login time'), auto_now_add=True)
...
class RustDeskTag(models.Model):
    ''' Tags
    '''
    uid = models.CharField(verbose_name=_('Owner user ID'), max_length=16)
    tag_name = models.CharField(verbose_name=_('Tag name'), max_length=60)
    tag_color = models.CharField(verbose_name=_('Tag color'), max_length=60, blank=True)
...
class MachineGroup(models.Model):
    '''Logical group of machines assigned to a user (for UI and permissions).'''
    ...
    name = models.CharField(verbose_name=_('Group name'), max_length=80)
...
class RustDeskPeer(models.Model):
    ...
    '''
    uid = models.CharField(verbose_name=_('User ID'), max_length=16)
    rid = models.CharField(verbose_name=_('Client ID'), max_length=60)
    username = models.CharField(verbose_name=_('OS username'), max_length=20)
    hostname = models.CharField(verbose_name=_('Computer name'), max_length=30)
    alias = models.CharField(verbose_name=_('Alias'), max_length=30)
    platform = models.CharField(verbose_name=_('Platform'), max_length=30)
    tags = models.CharField(verbose_name=_('Tags'), max_length=30)
    rhash = models.CharField(verbose_name=_('Device password hash'), max_length=60)
...
class RustDeskPeerAdmin(admin.ModelAdmin):
    list_display = ('rid', 'uid', 'username', 'hostname', 'platform', 'alias', 'tags', 'machine_group')
    search_fields = ('deviceid', 'alias')
    list_filter = ('rid', 'uid', 'machine_group')


class RustDesDevice(models.Model):
    rid = models.CharField(verbose_name=_('Client ID'), max_length=60, blank=True)
    cpu = models.CharField(verbose_name='CPU', max_length=100)
    hostname = models.CharField(verbose_name=_('Hostname'), max_length=100)
    memory = models.CharField(verbose_name=_('Memory'), max_length=100)
    os = models.CharField(verbose_name=_('Operating system'), max_length=100)
    uuid = models.CharField(verbose_name='uuid', max_length=100)
    username = models.CharField(verbose_name=_('OS username'), max_length=100, blank=True)
    version = models.CharField(verbose_name=_('Client version'), max_length=100)
    ip_address = models.CharField(verbose_name=_('IP'), max_length=60, blank=True)
    create_time = models.DateTimeField(verbose_name=_('Registered at'), auto_now_add=True)
    update_time = models.DateTimeField(verbose_name=_('Updated at'), auto_now=True, blank=True)
...
class ShareLink(models.Model):
    ...
    '''
    uid = models.CharField(verbose_name=_('User ID'), max_length=16)
    shash = models.CharField(verbose_name=_('Link key'), max_length=60)
    peers = models.CharField(verbose_name=_('Peer ID list'), max_length=20)
    ...
    create_time = models.DateTimeField(verbose_name=_('Created at'), auto_now_add=True)
